...
func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	...
	// Converte o slice de cursos para o tipo Course do GraphQL
	var coursesModel []*model.Course

	// Itera sobre o slice de cursos e converte para o tipo Course do GraphQL
	...
	// Retorna o slice de cursos do GraphQL
...
func (r *queryResolver) Categories(ctx context.Context) ([]*model.Category, error) {
	...
	// Convertendo o retorno da função FindAll para o tipo Category do GraphQL
	var categoriesModel []*model.Category

	// Itera sobre o slice de categorias e converte para o tipo Category do GraphQL
