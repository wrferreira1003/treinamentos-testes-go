...
type CategoryServiceClient interface {
	...
	GetCategory(ctx context.Context, in *GetCategoryGetRequest, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) GetCategory(ctx context.Context, in *GetCategoryGetRequest, opts ...grpc.CallOption) (*Category, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	GetCategory(context.Context, *GetCategoryGetRequest) (*Category, error)
...
func (UnimplementedCategoryServiceServer) GetCategory(context.Context, *GetCategoryGetRequest) (*Category, error) {
...
func _CategoryService_GetCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategory(ctx, req.(*GetCategoryGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
