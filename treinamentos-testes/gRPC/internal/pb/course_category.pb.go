...
type Category struct {
	...
	Id          string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // 1,2,3 e assim por diante é a ordem que o campo aparece na mensagem
...
type GetCategoryGetRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetCategoryGetRequest) Reset() {
	*x = GetCategoryGetRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCategoryGetRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCategoryGetRequest) ProtoMessage() {}

func (x *GetCategoryGetRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCategoryGetRequest.ProtoReflect.Descriptor instead.
func (*GetCategoryGetRequest) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{5}
}

func (x *GetCategoryGetRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x4d, 0x0a, 0x15,
	...
	0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x27, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x43, 0x61,
	...
	0x38, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x19,
	0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x47,
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*GetCategoryGetRequest)(nil), // 5: pb.GetCategoryGetRequest
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	1, // 5: pb.CategoryService.ListCategories:input_type -> pb.Empty
	5, // 6: pb.CategoryService.GetCategory:input_type -> pb.GetCategoryGetRequest
...
func file_proto_course_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_course_category_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*GetCategoryGetRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
